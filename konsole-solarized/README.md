...
Installation
------------
1. Copy the 'Solarized Dark.colorscheme' file to ~/.kde4/share/apps/konsole/.
2. Open Konsole and select Settings -> Configure Profiles -> Edit Profile -> Appearance -> 'Solarized Dark'.
3. Click OK, then OK again, and the Solarized Dark settings should have taken effect.
